function [symbol card] = ObservationToSymbol4(day, month, year, hour, prevFrequency, prevAvgVelocity)
...
card(2) = 5;
if  hour == 23 || hour == 24 || hour == 0 || hour == 1 || hour == 2 ||hour == 3 || hour == 4  || hour == 5
    assignment(2) = 1;
